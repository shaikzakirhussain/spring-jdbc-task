...
<nav class="navbar bg-primary">
	<div class="container-fluid ">
		<span class="navbar-brand mb-0 h1" style="color: white;">Tata Consaltuncy  Services
			</span>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="deleteTcs/${emp.id}"><button type="button"
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal"
	data-bs-target="#exampleModal" style="position: absolute; top:80%;">Add Employee</button>
...
function submitEdit() 
{
    ...
    console.log(form);
    $.ajax({
        url: "http://localhost:8080/SpringMVCPagination/editTcssave",
        type: "GET",
        data: form.serialize(),
        success: function() {
